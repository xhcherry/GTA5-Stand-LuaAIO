...
--- Dependencies
---
local inspect = require "lib.sakuralib.constructor.inspect"
local constructor_lib = require "lib.sakuralib.constructor.constructor_lib"
local constants = require "lib.sakuralib.constructor.constants"
local convertors = require "lib.sakuralib.constructor.convertors"
local curated_attachments = require "lib.sakuralib.constructor.curated_attachments"
local translations = require "lib.sakuralib.constructor.translations"
local scaleform = require('sakuralib.ScaleformLib')
...
local constructor = {}
local PROPS_PATH = filesystem.scripts_dir().."lib/sakuralib/constructor/objects_complete.txt"
