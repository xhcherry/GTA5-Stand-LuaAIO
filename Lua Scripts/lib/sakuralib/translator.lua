...
function L7_1()
  ...
  function L0_2(A0_3, A1_3, A2_3)
    ...
    L4_3 = async_http
    L4_3 = L4_3.init
    L5_3 = "translate.googleapis.com"
    L6_3 = "/translate_a/t?"
    L7_3 = tableToUrlParams
    L8_3 = L3_3
    L7_3 = L7_3(L8_3)
    L6_3 = L6_3 .. L7_3
    function L7_3(A0_4, A1_4, A2_4)
      local L3_4, L4_4, L5_4, L6_4, L7_4, L8_4
      if 200 == A2_4 and nil ~= A0_4 then
        L4_4 = A0_4
        L3_4 = A0_4.match
        L5_4 = "%[%[\"(.-)\",\"(.-)\"%]%]"
...
function L7_1(A0_2, A1_2, A2_2, A3_2, A4_2)
  ...
  L5_2 = createGoogleTranslateCall
  L6_2 = A3_2
  L5_2 = L5_2(L6_2)
  L6_2 = A0_2
  L7_2 = A1_2
...
function L9_1(A0_2, A1_2)
  ...
  function L2_2(A0_3, A1_3, A2_3, A3_3, A4_3, A5_3)
    ...
    L6_3 = A0_2.translateOn
    if not L6_3 then
      return
    end
    L6_3 = L7_1
    if not L6_3 then
      L6_3 = A0_2.translateSelf
      if not L6_3 then
        L6_3 = players
        L6_3 = L6_3.user
        L6_3 = L6_3()
        ...
        L6_3 = A1_2
        L7_3 = A2_3
        L8_3 = A0_2.targetLanguageIncoming
        ...
        function L11_3(A0_4, A1_4)
          ...
          L2_4 = L2_4(L3_4)
          L3_4 = A0_4
          L4_4 = A0_2.translatedMsgLocation
          L5_4 = A0_2.blacklistedLanguages
          L5_4 = L5_4[A1_4]
          if true == L5_4 then
            return
          end
...
function L16_1()
  ...
  L2_2 = async_http
  L2_2 = L2_2.init
  L3_2 = "api.gumengya.com"
  L4_2 = "/Api/Translate?format=json&text="
  L5_2 = url_encode
  L6_2 = L1_2
  L5_2 = L5_2(L6_2)
  L6_2 = "&from=auto&to=auto"
  L4_2 = L4_2 .. L5_2 .. L6_2
  ...
  if L6_2 then
    ...
    if not L6_2 then
      ...
      if not L6_2 then
        ...
        L6_2 = async_http
        L6_2 = L6_2.init
        L7_2 = "api.gumengya.com"
        L8_2 = "/Api/Translate?format=json&text="
        L9_2 = url_encode
        L10_2 = A2_2
        L9_2 = L9_2(L10_2)
...
function L17_1()
  ...
  L3_2 = async_http
  L3_2 = L3_2.init
  L4_2 = "translate.googleapis.com"
  L5_2 = "/translate_a/t?"
  L6_2 = tableToUrlParams
  L7_2 = L2_2
  L6_2 = L6_2(L7_2)
  L5_2 = L5_2 .. L6_2
...
L13_1 = createOnMessageCallback
L14_1 = Y0_1
L15_1 = translateText
L13_1, L14_1, L15_1, L16_1, L17_1, L18_1, L19_1, L20_1, L21_1, L22_1, L23_1, L24_1, L25_1, L26_1, L27_1, L28_1, L29_1, L30_1, L31_1, L32_1, L33_1, L34_1, L35_1, L36_1, L37_1, L38_1, L39_1, L40_1, L41_1, L42_1, L43_1, L44_1, L45_1, L46_1, L47_1, L48_1, L49_1, L50_1, L51_1 = L13_1(L14_1, L15_1)
L12_1(L13_1, L14_1, L15_1, L16_1, L17_1, L18_1, L19_1, L20_1, L21_1, L22_1, L23_1, L24_1, L25_1, L26_1, L27_1, L28_1, L29_1, L30_1, L31_1, L32_1, L33_1, L34_1, L35_1, L36_1, L37_1, L38_1, L39_1, L40_1, L41_1, L42_1, L43_1, L44_1, L45_1, L46_1, L47_1, L48_1, L49_1, L50_1, L51_1)
L12_1 = menu
L12_1 = L12_1.divider
L13_1 = chat_transl
L14_1 = "设置"
