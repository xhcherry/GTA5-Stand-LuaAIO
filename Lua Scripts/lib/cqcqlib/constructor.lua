...
local status_natives, natives = pcall(require, "lib.cqcqlib.natives-1663599433")
...
--if #missing_required_dependencies > 0 then
  --  local missing_files = table.concat(missing_required_dependencies, ", ")
    ...
    --    menu.readonly(constructor, "Error: Install Failed", "Auto-update failed and required files are missing ("..missing_files..") Please re-install from the project zip file.")
      --  menu.hyperlink(constructor, "Download Full Project Zip", "https://github.com/hexarobi/stand-lua-constructor")
    ...
    --else
      --  menu.readonly(constructor, "Error: Load Failed", "Required files are missing. ("..missing_files..")")
      --  --if config.auto_update then
        --    menu.hyperlink(constructor, "Discord Help", "https://discord.gg/2u5HbHPB9y")
      --  else
          --  menu.readonly(constructor, "Please Update", "Please clean reinstall or manually update from the project homepage.")
          --  menu.action(constructor, "Clean Reinstall", {}, "Force an update to the latest version, regardless of current version.", function()
...
-- Shorthand wrapper for translation function
local translations = require "lib/constructor/translations"
...
local constants = require "lib/constructor/constants"
local curated_attachments = require "lib/constructor/curated_attachments"
pcall(menu.delete, loading_menu)
local constructor = {}

local PROPS_PATH = filesystem.scripts_dir().."lib/constructor/objects_complete.txt"
local constructor_lib = require "lib/constructor/constructor_lib"
local convertors = require "lib/constructor/convertors"
...
menus.create_new_construct = menu.list(constructorscript,t("Create New Construct"), {}, t("Create a new construct from a base vehicle, object, or ped. Then extend it with attachments. Finally save your creation and share it with others."))
...
menus.load_construct = menu.list(constructorscript, t("Load Construct"), {"constructorloadconstruct"}, t("Load a previously saved or shared construct into the world"), function()
    menus.rebuild_load_construct_menu()
    if #load_constructs_root_menu_file.menus == 0 then
        util.toast("No constructs found!", TOAST_ALL)
        menu.show_warning(constructorscript, CLICK_COMMAND, t(
...
menus.loaded_constructs = menu.list(constructorscript, t("Loaded Constructs").." ("..#spawned_constructs..")", {}, t("View and edit already loaded constructs"))
...
menus.settings_menu = menu.list(constructorscript, t("Settings"), {}, t("Set global configuration options."))
...
--local script_meta_menu = menu.list(constructor, t("Script Meta"), {}, t("Information and options about the Constructor script itself."))
