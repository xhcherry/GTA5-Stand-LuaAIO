...
local required <const> = {
    "lib/libliblib/functions.lua",
	"lib/libliblib/pretty/json.lua",
	"lib/libliblib/pretty/json/constant.lua",
	"lib/libliblib/pretty/json/parser.lua",
	"lib/libliblib/pretty/json/serializer.lua",
}
local Functions = require ("lib.libliblib.functions")
...
local baibaiDir <const> = scriptdir .. "baibaiScript\\"
...
function ProfileManager.new(parent)
	...
	local trans_SpoofingProfiles = "虚假配置文件"
...
Weapons =
 ...
 function Member:save()
	 ...
	 local path = baibaiDir .. "bodyguards\\" .. input .. ".json"
...
menu.textslider_stateful(bodyguard_heli_options, "直升机类型", {}, "", sel_heli_name_list, function(value)
...
---------------------
	 ...
	 local saved = FilesList.new(self.ref, "已保存的", baibaiDir .. "bodyguards", "json")
