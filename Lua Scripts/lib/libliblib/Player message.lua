...
--folders
txt = menu.list(menu.my_root(), "文本颜色", {}, "", function()
	customisation_open = true
end, function()
	customisation_open = false
end)
background = menu.list(menu.my_root(), "背景颜色", {}, "", function()
	customisation_open = true
end, function()
	customisation_open = false
end)
border = menu.list(menu.my_root(), "边框颜色", {}, "", function()
	customisation_open = true
end, function()
	customisation_open = false
end)
position_folder = menu.list(menu.my_root(), "位置", {}, "", function()
	customisation_open = true
end, function()
	customisation_open = false
end)
...
menu.action(menu.my_root(), "显示当前颜色值", {}, "", function()
...
--info overlay
menu.toggle(menu.my_root(), "启用", {}, "个人玩家信息显示", function(state)
    UItoggle = state
end)
