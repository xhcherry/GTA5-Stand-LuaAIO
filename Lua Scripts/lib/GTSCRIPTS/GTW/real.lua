...
welcomet1 = menu.toggle_loop(players_root, "you can't see it", {"ucantseeit"}, "", function ()
    notification(welcomehb()..PLAYER.GET_PLAYER_NAME(players.user()).."\n".."GT_version:"..GT_version)
    
end)

welcomet2 = menu.toggle_loop(players_root, "you can't see it", {"youcantseeit"}, "", function ()
