...
local stfu_dir = filesystem.scripts_dir() .. "/lib/" .. '/baibaislib/'


if not filesystem.exists(stfu_dir) then
	notification("cnm sb",colors.red)
else
	util.register_file(stfu_dir .. "stfu.lua")
end
