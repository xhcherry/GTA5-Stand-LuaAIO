...
local status_constants, constants = pcall(require, "lib.GTlib.GTC.lib.constants")
if not status_constants then error("Could not load constants lib. This should have been auto-installed.") end

local status_constants, constants = pcall(require, "lib.GTlib.GTC.lib.quaternionLib")
if not status_constants then error("Could not load constants lib. This should have been auto-installed.") end
