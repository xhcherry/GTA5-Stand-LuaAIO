...
VERSION = "1.10.10"
local ANIMATIONS_DATA_FILE = filesystem.scripts_dir().. "/GTScript/actions/animations.txt"
...
local status = pcall(require, 'lib.GTlib.playerlib')
if not status then
    util.toast("加载资源文件失败: lib.GTlib.playerlib")
    util.stop_script()
end
...
function download_animation_data()
    ...
    async_http.init("jackz.me", "/stand/GTScript/actions/animations.txt", function(result)
