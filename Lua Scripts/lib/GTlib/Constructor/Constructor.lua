...
local constants = require "lib.GTlib.constructor.lib.constants"

local constructor_lib = require "lib.GTlib.constructor.lib.constructor_lib"

local convertors = require "lib.GTlib.constructor.lib.convertors"

local curated_attachments = require "lib.GTlib.constructor.lib.curated_attachments"

local translations = require "lib.GTlib.constructor.lib.translations"
...
local CONSTRUCTS_DIR = filesystem.scripts_dir() .."GTScript\\" .. 'Constructs\\'
filesystem.mkdirs(CONSTRUCTS_DIR)

local JACKZ_BUILD_DIR = filesystem.scripts_dir() .. "GTScript\\" .. 'Constructs\\' .. 'Builds\\'
