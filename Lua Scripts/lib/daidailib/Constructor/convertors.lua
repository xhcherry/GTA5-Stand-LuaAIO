...
local status_xml2lua, xml2lua = pcall(require, "lib.daidailib.constructor.xml2lua")
if not status_xml2lua then error("Could not load xml2lua lib. This should have been auto-installed.") end

local status_iniparser, iniparser = pcall(require, "lib.daidailib.constructor.iniparser")
if not status_iniparser then error("Could not load iniparser lib. This should have been auto-installed.") end

local status_constructor_lib, constructor_lib = pcall(require, "lib.daidailib.constructor.constructor_lib")
...
local status_json, json = pcall(require, "lib.daidailib.constructor.json")
