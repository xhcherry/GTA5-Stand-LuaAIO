...
local LIBDIR = filesystem.scripts_dir() .. "lib\\daidailib\\CustomWeapon\\"
local do_autoload = false
local wpcmpTable = {}
local weapons_table = {}
if filesystem.exists(LIBDIR .. "weaponlist.lua") then
    wpcmpTable = require("lib.daidailib.CustomWeapon.weaponlist")
...
select_loadout = menu.list_select(weapon_save,"选择配置", {}, "选择要使用的武器配置", saved_loadouts, 1, function () end)
