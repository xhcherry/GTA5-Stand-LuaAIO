...
util.ensure_package_is_installed('lua/Musicjson')
local status_json, json = pcall(require, "Musicjson")
if not status_json then error("Could not load json lib. Make sure it is selected under Stand > Lua Scripts > Repository > Musicjson") end
