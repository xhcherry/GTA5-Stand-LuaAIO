...
local status_inspect, inspect = pcall(require, "lib.baibailib.constructor.lib.inspect")
if not status_inspect then error("Could not load inspect lib. This should have been auto-installed.") end

local status_xml2lua, xml2lua = pcall(require, "lib.baibailib.constructor.lib.xml2lua")
if not status_xml2lua then error("Could not load xml2lua lib. This should have been auto-installed.") end

local status_iniparser, iniparser = pcall(require, "lib.baibailib.constructor.lib.iniparser")
if not status_iniparser then error("Could not load iniparser lib. This should have been auto-installed.") end

local status_constructor_lib, constructor_lib = pcall(require, "lib.baibailib.constructor.lib.constructor_lib")
if not status_constructor_lib then error("Could not load constructor_lib. This should have been auto-installed.") end

local status_json, json = pcall(require, "lib.baibailib.constructor.lib.json")
