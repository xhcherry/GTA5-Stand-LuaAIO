...
VERSION = "1.10.10"
local ANIMATIONS_DATA_FILE = filesystem.scripts_dir().. "/YMS/actions/animations.txt"
...
local status = pcall(require, 'lib.YeMulib.YMactions.actions_data')
if not status then
    util.toast("加载资源文件失败: lib.YeMulib.YMactions.actions_data")
    util.stop_script()
end
