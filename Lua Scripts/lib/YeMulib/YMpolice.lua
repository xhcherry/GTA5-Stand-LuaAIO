...
logo = directx.create_texture(filesystem.scripts_dir() .. '/resources/'..'Bodycam.png')
...
if not filesystem.exists(resource_dir) then
	...
	util.register_file(resource_dir .. "call911.ytd")
end

if not filesystem.exists(resource_dir) then
	util.toast("resource directory not found. notification system will be less of a bruh")
else
	util.register_file(resource_dir .. "char_blocked.ytd")
end
