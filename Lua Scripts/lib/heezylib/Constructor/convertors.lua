...
local status_inspect, inspect = pcall(require, "lib.heezylib.constructor.inspect")
if not status_inspect then error("Could not load inspect lib. This should have been auto-installed.") end

local status_xml2lua, xml2lua = pcall(require, "lib.heezylib.constructor.xml2lua")
if not status_xml2lua then error("Could not load xml2lua lib. This should have been auto-installed.") end

local status_iniparser, iniparser = pcall(require, "lib.heezylib.iniparser")
if not status_iniparser then error("Could not load iniparser lib. This should have been auto-installed.") end

local status_constructor_lib, constructor_lib = pcall(require, "lib.heezylib.constructor.constructor_lib")
...
local status_json, json = pcall(require, "lib.heezylib.constructor.json")
