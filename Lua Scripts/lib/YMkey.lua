...
function YMkey.is_key_down(string_or_int)
    local keyCode = getKeyCode(string_or_int)
    return util.is_key_down(keyCode)
end

function YMkey.is_key_just_down(string_or_int)
    local keyCode = getKeyCode(string_or_int)
...
function YMkey.get_ms_since_last_press(string_or_int)
    local keyCode = getKeyCode(string_or_int)
    local isDown = util.is_key_down(keyCode)
...
function YMkey.get_control_group_instructional_button(controlType, control)
...
function YMkey.get_ms_since_control_last_pressed(controlType, control)
