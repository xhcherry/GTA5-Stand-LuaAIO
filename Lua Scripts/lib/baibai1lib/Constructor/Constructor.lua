...
local inspect = require "lib.baibai1lib.constructor.lib.inspect"

local constants = require "lib.baibai1lib.constructor.lib.constants"

local constructor_lib = require "lib.baibai1lib.constructor.lib.constructor_lib"

local convertors = require "lib.baibai1lib.constructor.lib.convertors"

local curated_attachments = require "lib.baibai1lib.constructor.lib.curated_attachments"

local translations = require "lib.baibai1lib.constructor.lib.translations"
...
local CONSTRUCTS_DIR = filesystem.scripts_dir() .."baibaiScript\\" .. 'Constructs\\'
filesystem.mkdirs(CONSTRUCTS_DIR)

local JACKZ_BUILD_DIR = filesystem.scripts_dir() .. "baibaiScript\\" .. 'Constructs\\' .. 'Builds\\'
...
menus.create_new_construct = menu.list(Constructor_Lua, t("Create New Construct"), {}, t("Create a new construct from a base vehicle, object, or ped. Then extend it with attachments. Finally save your creation and share it with others."))
...
menus.load_construct = menu.list(Constructor_Lua, t("Load Construct"), {"constructorloadconstruct"}, t("Load a previously saved or shared construct into the world"), function()
    ...
    if #load_constructs_root_menu_file.menus == 0 then
        ...
        menu.show_warning(Constructor_Lua, CLICK_COMMAND, t(
...
menus.settings_menu = menu.list(Constructor_Lua, t("Settings"), {}, t("Set global configuration options."))
