...
CONSTRUCTOR_CONFIG = {
    ...
    focus_menu_on_spawned_constructs = false,----生成组件自动切换父级菜单
...
local auto_update_config = {
    ...
    dependencies={
        ...
        --},
        {
            ...
            script_relpath="lib/YMlib/constructor/constants.lua",
            switch_to_branch=selected_branch,
            verify_file_begins_with="--",
            check_interval=default_check_interval,
            is_required=true,
        },
        {
            ...
            script_relpath="lib/YMlib/constructor/constructor_lib.lua",
            switch_to_branch=selected_branch,
            verify_file_begins_with="--",
            check_interval=default_check_interval,
            is_required=true,
        },
        {
            ...
            script_relpath="lib/YMlib/constructor/iniparser.lua",
            switch_to_branch=selected_branch,
            verify_file_begins_with="--",
            check_interval=default_check_interval,
        },
        {
            ...
            script_relpath="lib/YMlib/constructor/convertors.lua",
            switch_to_branch=selected_branch,
            verify_file_begins_with="--",
            check_interval=default_check_interval,
            is_required=true,
        },
        {
            ...
            script_relpath="lib/YMlib/constructor/curated_attachments.lua",
            verify_file_begins_with="--",
            check_interval=default_check_interval,
            is_required=true,
        },
        {
            ...
            script_relpath="lib/YMlib/constructor/translations.lua",
            switch_to_branch=selected_branch,
            verify_file_begins_with="--",
            check_interval=default_check_interval,
            is_required=true,
        },
        {
            ...
            script_relpath="lib/YMlib/constructor/constructor_logo.png",
            check_interval=default_check_interval,
        },
        {
            ...
            script_relpath="lib/YMlib/constructor/objects_complete.txt",
...
if #missing_required_dependencies > 0 then
    ...
    if not update_success then
        menu.readonly(diyi, "Error: Install Failed", "Auto-update failed and required files are missing ("..missing_files..") Please re-install from the project zip file.")
        menu.hyperlink(diyi, "Download Full Project Zip", "https://github.com/hexarobi/stand-lua-constructor")
        ...
        menu.readonly(diyi, "Error: Load Failed", "Required files are missing. ("..missing_files..")")
        if config.auto_update then
            menu.hyperlink(diyi, "Discord Help", "https://discord.gg/2u5HbHPB9y")
        else
            menu.readonly(diyi, "Please Update", "Please clean reinstall or manually update from the project homepage.")
            menu.action(diyi, "Clean Reinstall", {}, "Force an update to the latest version, regardless of current version.", function()
...
local PROPS_PATH = filesystem.scripts_dir().."lib/YMlib/constructor/objects_complete.txt"
...
menus.create_new_construct = menu.list(diyi, t("Create New Construct"), {}, t("Create a new construct from a base vehicle, object, or ped. Then extend it with attachments. Finally save your creation and share it with others."))
...
menus.load_construct = menu.list(diyi, t("Load Construct"), {"constructorloadconstruct"}, t("Load a previously saved or shared construct into the world"), function()
    menus.rebuild_load_construct_menu()
    if #load_constructs_root_menu_file.menus == 0 then
        util.toast("库里还没有模组哦!", TOAST_ALL)
            menus.rebuild_load_construct_menu()
    end
end)
...
menus.loaded_constructs = menu.list(diyi, t("Loaded Constructs").." ("..#spawned_constructs..")", {}, t("View and edit already loaded constructs"))
...
menus.settings_menu = menu.list(diyi, t("Settings"), {}, t("Set global configuration options."))
...
local script_meta_menu = menu.list(diyi, t("Script Meta"), {}, t("Information and options about the Constructor script itself."))
menu.divider(script_meta_menu, t("Constructor"))
menu.readonly(script_meta_menu, t("Version"), "0.33")
---
--- Run
---
