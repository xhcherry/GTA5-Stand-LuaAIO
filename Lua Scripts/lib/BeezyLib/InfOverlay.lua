...
local textures =
{
    map = directx.create_texture(filesystem.scripts_dir() .. '\\HeezyScript\\'.. 'GTA Map.png'),
    blip = directx.create_texture(filesystem.scripts_dir() .. '\\HeezyScript\\'.. 'defaultblip.png')
}
