...
--- Lua Script Settings
    ...
    local NativeDir = filesystem.scripts_dir() .. "lib/BeezyLib\\natives-1672190175.lua"
    FolderDirs = {
        Img = HC_DIR .. "Image\\",
...
--- Main Lists
    ...
    local PERICO_HEIST = menu.list(HeistControl_features, TRANSLATE("Cayo Perico Heist"), {"hccp"}, "", function();  end)
    local CASINO_HEIST = menu.list(HeistControl_features, TRANSLATE("Diamond Casino Heist"), {"hccah"}, "", function(); end)
    local DOOMS_HEIST = menu.list(HeistControl_features, TRANSLATE("Doomsday Heist"), {"hcdooms"}, "", function(); end)
    local CLASSIC_HEISTS = menu.list(HeistControl_features, TRANSLATE("Classic Heist"), {"hcclassic"}, "", function(); end)
    local LS_ROBBERY = menu.list(HeistControl_features, TRANSLATE("LS Tuners Robbery"), {"hcls"}, "", function(); end)
    local ULP_MISSIONS = menu.list(HeistControl_features, TRANSLATE("ULP Missions"), {"hculp"}, "", function(); end)
    local TH_CONTRACT = menu.list(HeistControl_features, TRANSLATE("The Contract: Agency"), {"hcagc"}, "", function(); end)
    local MASTER_UNLOCKR = menu.list(HeistControl_features, TRANSLATE("Master Unlocker"), {"hcmu"}, "", function(); end)
    local TOOLS = menu.list(HeistControl_features, TRANSLATE("Tools"), {"hctool"}, "", function(); end)
    local INFOS = menu.list(HeistControl_features, TRANSLATE("Settings And About HC"), {"hcinfo"}, "", function(); end)
