...
CONSTRUCTOR_CONFIG = {
    ...
    debug_mode = false,
    auto_update = false,
    auto_update_check_interval = 999999999999999999999999,
    freecam_speed = 1,
...
local inspect = require("lib/BeezyLib/Constructor/inspect")
local xml2lua = require("lib/BeezyLib/Constructor/xml2lua")
local constants = require("lib/BeezyLib/Constructor/constants")
local constructor_lib = require("lib/BeezyLib/Constructor/constructor_lib")
local iniparser = require("lib/BeezyLib/iniparser")
local convertors = require("lib/BeezyLib/Constructor/convertors")
local curated_attachments = require("lib/BeezyLib/Constructor/curated_attachments")
local translations = require("lib/BeezyLib/Constructor/translations")
...
local PROPS_PATH = filesystem.scripts_dir().."lib\\BeezyLib\\constructor\\".."objects_complete.txt"
local VERSION_STRING = SCRIPT_VERSION.." / "..constructor_lib.LIB_VERSION .. " / " .. convertors.SCRIPT_VERSION

local CONSTRUCTS_DIR = filesystem.scripts_dir() .."HeezyScript\\" .. 'Constructs\\'
filesystem.mkdirs(CONSTRUCTS_DIR)

local JACKZ_BUILD_DIR = filesystem.scripts_dir() .. "HeezyScript\\" .. 'Constructs\\' .. 'Builds\\'
...
local function install_curated_constructs()
    local to_path = filesystem.store_dir().."/Constructs Installer.lua"
...
menus.create_new_construct = menu.list(model_options, t("Create New Construct"), {}, t("Create a new construct from a base vehicle, object, or ped. Then extend it with attachments. Finally save your creation and share it with others."))
...
--    local file = io.open(filesystem.store_dir().."/lib/vehicles.json")
...
menus.load_construct = menu.list(model_options, t("Load Construct"), {"constructorloadconstruct"}, t("Load a previously saved or shared construct into the world"), function()
    menus.rebuild_load_construct_menu()
    if #load_constructs_root_menu_file.menus == 0 then
        util.toast("No constructs found!", TOAST_ALL)
        menu.show_warning(model_options, CLICK_COMMAND, t(
...
menus.loaded_constructs = menu.list(model_options, t("Loaded Constructs").." ("..#spawned_constructs..")", {}, t("View and edit already loaded constructs"))
...
menus.settings_menu = menu.list(model_options, t("Settings"), {}, t("Set global configuration options."))
...
local script_meta_menu = menu.list(model_options, t("Script Meta"), {}, t("Information and options about the Constructor script itself."))
...
if SCRIPT_MANUAL_START and not SCRIPT_SILENT_START then
    local logo_path = filesystem.scripts_dir() .. '/lib/BeezyLib/Constructor/constructor_logo.png'
