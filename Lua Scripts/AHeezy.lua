...
local bigbarrelqq = false
        ...
        menu.toggle_loop(weapon_features, "激光眼", {"lasereyes"}, "", function(on)
            laser_eyes()
        end)
...
watch_dog = menu.list(interesting_features, "看门狗PLUS", {}, "", function(); end)
...
dofile(filesystem.scripts_dir().."\\BeezyLib\\WatchDogsPlus.lua")
